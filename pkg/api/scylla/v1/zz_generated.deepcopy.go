...
func (in *CertsSpec) DeepCopyInto(out *CertsSpec) {
	*out = *in
	if in.UserManagedOptions != nil {
		...
		*out = new(UserManagedCertManagementSpecOptions)
		**out = **in
	}
	if in.OperatorManagedOptions != nil {
		in, out := &in.OperatorManagedOptions, &out.OperatorManagedOptions
		*out = new(OperatorManagedCertManagementSpecOptions)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OperatorManagedCertManagementSpecOptions) DeepCopyInto(out *OperatorManagedCertManagementSpecOptions) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OperatorManagedCertManagementSpecOptions.
func (in *OperatorManagedCertManagementSpecOptions) DeepCopy() *OperatorManagedCertManagementSpecOptions {
	if in == nil {
		return nil
	}
	out := new(OperatorManagedCertManagementSpecOptions)
...
func (in *ScyllaClusterSpec) DeepCopyInto(out *ScyllaClusterSpec) {
	*out = *in
	...
	if in.CertsSpec != nil {
		in, out := &in.CertsSpec, &out.CertsSpec
		*out = new(CertsSpec)
		(*in).DeepCopyInto(*out)
	}
	return
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UserManagedCertManagementSpecOptions) DeepCopyInto(out *UserManagedCertManagementSpecOptions) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UserManagedCertManagementSpecOptions.
func (in *UserManagedCertManagementSpecOptions) DeepCopy() *UserManagedCertManagementSpecOptions {
	if in == nil {
		return nil
	}
	out := new(UserManagedCertManagementSpecOptions)
