...
func (in *CertificateOptions) DeepCopyInto(out *CertificateOptions) {
	*out = *in
	if in.ServingCA != nil {
		in, out := &in.ServingCA, &out.ServingCA
		*out = new(TLSCertificateAuthority)
		(*in).DeepCopyInto(*out)
	}
	if in.ClientCA != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OperatorManagedTLSCertificateAuthorityOptions) DeepCopyInto(out *OperatorManagedTLSCertificateAuthorityOptions) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OperatorManagedTLSCertificateAuthorityOptions.
func (in *OperatorManagedTLSCertificateAuthorityOptions) DeepCopy() *OperatorManagedTLSCertificateAuthorityOptions {
	if in == nil {
		return nil
	}
	out := new(OperatorManagedTLSCertificateAuthorityOptions)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TLSCertificateAuthority) DeepCopyInto(out *TLSCertificateAuthority) {
	*out = *in
	if in.UserManagedOptions != nil {
		in, out := &in.UserManagedOptions, &out.UserManagedOptions
		*out = new(UserManagedTLSCertificateAuthorityOptions)
		**out = **in
	}
	if in.OperatorManagedOptions != nil {
		in, out := &in.OperatorManagedOptions, &out.OperatorManagedOptions
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TLSCertificateAuthority.
func (in *TLSCertificateAuthority) DeepCopy() *TLSCertificateAuthority {
	if in == nil {
		return nil
	}
	out := new(TLSCertificateAuthority)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UserManagedTLSCertificateAuthorityOptions) DeepCopyInto(out *UserManagedTLSCertificateAuthorityOptions) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UserManagedTLSCertificateAuthorityOptions.
func (in *UserManagedTLSCertificateAuthorityOptions) DeepCopy() *UserManagedTLSCertificateAuthorityOptions {
	if in == nil {
		return nil
	}
	out := new(UserManagedTLSCertificateAuthorityOptions)
