...
type ScyllaDBManagerTaskSpec struct {
	// scyllaDBCluster is a typed reference to the target cluster in the same namespace.
	// Supported kinds are ScyllaCluster (scylla.scylladb.com/v1) and ScyllaDBCluster (scylla.scylladb.com/v1alpha1).
	ScyllaDBCluster LocalScyllaDBReference `json:"scyllaDBCluster"`
