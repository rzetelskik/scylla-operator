...
func (sdcc *Controller) syncCerts(
	...
	if utilfeature.DefaultMutableFeatureGate.Enabled(features.AutomaticTLSCertificates) {
		...
		clientCATLSCertificateType := scyllav1alpha1.TLSCertificateTypeOperatorManaged
		...
		case scyllav1alpha1.TLSCertificateTypeOperatorManaged:
			// TODO(rzetelskik): support additional dns names and additional ip addresses
	...
	if utilfeature.DefaultMutableFeatureGate.Enabled(features.AutomaticTLSCertificates) {
		...
		servingCATLSCertificateType := scyllav1alpha1.TLSCertificateTypeOperatorManaged
