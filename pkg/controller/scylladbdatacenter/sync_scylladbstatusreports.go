...
func (sdcc *Controller) syncScyllaDBStatusReports(
	...
	scyllaDBStatusReport, scyllaDBStatusReportProgressingConditions, err := makeScyllaDBStatusReport(sdc, services, sdcc.podLister)
	progressingConditions = append(progressingConditions, scyllaDBStatusReportProgressingConditions...)
	if err != nil {
