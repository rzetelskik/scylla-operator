...
type Interface interface {
	...
	// ScyllaDBManagers returns a ScyllaDBManagerInformer.
	ScyllaDBManagers() ScyllaDBManagerInformer
...
// ScyllaDBManagers returns a ScyllaDBManagerInformer.
func (v *version) ScyllaDBManagers() ScyllaDBManagerInformer {
	return &scyllaDBManagerInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
